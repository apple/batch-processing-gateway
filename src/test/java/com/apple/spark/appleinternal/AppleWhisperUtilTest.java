...
public class AppleWhisperUtilTest {
  ...
  public void enableWhisperSupportTest(){
    ...
    Assert.assertEquals(sparkSpec.getDriver().getAnnotations().get(WhisperConstants.WHISPER_HYDROGEN_USER_KEY),"dummyUser");
    Assert.assertEquals(sparkSpec.getDriver().getAnnotations().get(WhisperConstants.WHISPER_ISSUERNAME_KEY),WhisperConstants.WHISPER_ISSUERNAME);
  }
  @Test
  ...
  @Test
    public void withoutBucketTest(){
      ...
      Assert.assertFalse(sparkSpec.getDriver().getAnnotations().containsKey(WhisperConstants.WHISPER_HYDROGEN_USER_KEY));
      Assert.assertFalse(sparkSpec.getDriver().getAnnotations().containsKey(WhisperConstants.WHISPER_ISSUERNAME_KEY));
  }
