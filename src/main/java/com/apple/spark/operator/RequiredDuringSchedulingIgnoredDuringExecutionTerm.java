...
public class RequiredDuringSchedulingIgnoredDuringExecutionTerm {

  private NodeSelectorTerm[] nodeSelectorTerms;

  public RequiredDuringSchedulingIgnoredDuringExecutionTerm() {}

  public RequiredDuringSchedulingIgnoredDuringExecutionTerm(NodeSelectorTerm[] nodeSelectorTerms) {
